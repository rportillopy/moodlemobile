...
var MM = {
    ...
    addSite: function(e) {
        ...
        // We are not going to never fallback to http from https
...
*/
     ...
     */
    saveSite: function(username, password, siteurl, originalProtocol) {
        ...
        // Lower tiemout if we are checking using a different protocol than the original.
        if (siteurl.indexOf(originalProtocol) == -1) {
            timeout = 10000;
        }
                ...
                if (typeof(json.token) != 'undefined') {
                    ...
                    if (typeof(json.error) != 'undefined') {
                        ...
                        if (originalProtocol == "http://") {
                            MM.saveSite(username, password, siteurl.replace("https://", "http://"), originalProtocol);
                            return;
                        }
